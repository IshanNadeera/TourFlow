        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.bottomSection}>
                ...
                <View style={styles.header}>
                    <Text style={{fontSize: 35, color:Colors.mainColor2, fontWeight: 'bold', flex:2, fontFamily: 'sans-serif-condensed'}}>{location_name}</Text>
                ...
                <View style={styles.details}>
                    ...
                    <Text style={{fontSize: 18, color:Colors.fontColor1, fontFamily: 'sans-serif-condensed'}}>{location_city}</Text>
