...
const RestaurantSingle = ({navigation, route}) => {
  //Setters and Getters
  const [restaurantId, setRestaurantId] = useState(route.params.id);
  const [restaurantName, setRestaurantName] = useState(route.params.name);
  const [restaurantCity, setRestaurantCity] = useState(route.params.city);
  ...
  const [restaurantUrl, setRestaurantUrl] = useState(route.params.url);
  const [newRestaurantUrl, setNewRestaurantUrl] = useState('');
  ...
  const chooseFile = type => {
    ...
    launchImageLibrary(options, response => {
      ...
      setNewRestaurantUrl(response.assets[0].base64);
    });
  };
  ...
  const updateData = () => {
    firestore()
      ...
      .update({
        ...
        restaurant_url: newRestaurantUrl == '' ? restaurantUrl : newRestaurantUrl,
      })
      .then(() => {
        SweetAlert.showAlertWithOptions(
          {
    ...
    firestore()
      ...
      .then(() => {
        SweetAlert.showAlertWithOptions(
          {
            title: 'Success!',
            subTitle: 'Restaurant Deleted Successfully!',
            confirmButtonTitle: 'OK',
            confirmButtonColor: 'green',
            style: 'success',
            cancellable: false,
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.topSection}>
        <ImageBackground
          source={{uri: 'data:image/png;base64,' + restaurantUrl}}
          resizeMode="cover"
      ...
      <View style={styles.bottomSection}>
        <View style={styles.header}>
          ...
          <Lottie
            style={{width: '22%',right:13, top:7}}
            source={require('../../../img/5s.json')}
            autoPlay
            loop
          />
        </View>
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <TouchableOpacity onPress={() => chooseFile('photo')}>
              <View style={styles.uploadContainer}>
                {newRestaurantUrl == '' ? (
                  ...
                  <Image
                    source={{uri: 'data:image/png;base64,' + newRestaurantUrl}}
                    style={styles.imageStyle}
                  />
                )}
              </View>
            ...
            <TextInput
              ...
              onChangeText={description => setRestaurantDescription(description)}
            />
